...
import EncomendasAdminLista from "../routes/admin/encomendas/EncomendasAdminLista"
import EncomendaFormulario from "../routes/admin/encomendas/EncomendaFormulario"
import EncomendaEdicao from "../routes/admin/encomendas/EncomendaEdicao"
        ...
        children:[
            ...
            criarRotaAdmin("avaliacoes", ListaAvaliacoes, AvaliacaoFormulario),
            {
                ...
                children: [
                    {
                        index: true,
                        Component: EncomendasAdminLista
                    },
                    {
                        path: "adicionar",
                        Component: EncomendaFormulario
                    },
                    {
                        path: "editar",
                        children: [
