      ...
      <div className="head">
        ...
        <div className="dista">
          <div className="search-box">
            ...
            <button
              onClick={() => {
                const consulta_lower = valores.consulta.toLowerCase();
                const paises = ['brasil', 'italy', 'italia', 'france', 'frança', 'spain', 'espanha', 'germany', 'alemanha', 'japan', 'japão', 'mexico', 'méxico', 'iran', 'irã', 'morocco', 'marrocos', 'australia', 'austrália'];
                
                if (paises.includes(consulta_lower)) {
                  navigate(Rotas.paises.detalhes.rota(valores.consulta));
                } else if (consulta) {
