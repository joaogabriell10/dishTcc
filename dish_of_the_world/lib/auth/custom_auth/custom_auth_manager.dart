...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    dishOfTheWorldAuthUserSubject.add(
      DishOfTheWorldAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<DishOfTheWorldAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  DishOfTheWorldAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = DishOfTheWorldAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    dishOfTheWorldAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
DishOfTheWorldAuthUser? currentUser;
